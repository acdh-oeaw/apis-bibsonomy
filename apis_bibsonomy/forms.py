...
from .autocompletes import CitationsAutocomplete
...
class ReferenceForm(ModelForm):
    ...
    class Meta:
        ...
        attrs = {'data-placeholder': 'Type to get suggestions',
                 'data-html': True}
        widgets = {'bibs_url': ListSelect2(url='bibsonomy:citationautocomplete', attrs=attrs)}
    ...
    def __init__(self, content_type=None, object_pk=None, attribute_name=None, hidden=False, *args, **kwargs):
        ...
        self.helper.form_action = reverse('bibsonomy:savegetcitationentry')
