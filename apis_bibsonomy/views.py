...
class ReferenceOnListView(ReferenceListView, FormMixin, ProcessFormView):
    ...
    def form_valid(self, form):
        ...
        self.request.session["last_bibsonomy_reference_title"] = (
            ref.zoteroentry.bibtex.get("title")
        )
...
class ZoteroEntryAutocompleteSelect(DetailView):
    model = ZoteroEntry
    template_name = "apis_bibsonomy/zoteroentry_autocomplete_select.html"
